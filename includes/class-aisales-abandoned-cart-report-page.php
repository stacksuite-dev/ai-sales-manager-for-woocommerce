...
class AISales_Abandoned_Cart_Report_Page {
	...
	public function add_submenu_page() {
		add_submenu_page(
			'ai-sales-manager',
			__( 'Abandoned Carts', 'stacksuite-sales-manager-for-woocommerce' ),
			__( 'Abandoned Carts', 'stacksuite-sales-manager-for-woocommerce' ),
			'manage_woocommerce',
	...
	public function render_page() {
		...
		<div class="wrap aisales-abandoned-carts-page">
			...
			<div class="aisales-abandoned-carts-page__header">
				<h2 class="aisales-abandoned-carts-page__title"><?php esc_html_e( 'Abandoned Carts', 'stacksuite-sales-manager-for-woocommerce' ); ?></h2>
			...
			<div class="aisales-stats-grid aisales-stats-grid--4col aisales-abandoned-carts-page__stats">
				<div class="aisales-stat-card">
					...
					<span class="aisales-stat-card__label"><?php esc_html_e( 'Abandoned', 'stacksuite-sales-manager-for-woocommerce' ); ?></span>
				</div>
				<div class="aisales-stat-card">
					<span class="aisales-stat-card__value"><?php echo esc_html( number_format_i18n( $stats['recovered'] ) ); ?></span>
					<span class="aisales-stat-card__label"><?php esc_html_e( 'Recovered', 'stacksuite-sales-manager-for-woocommerce' ); ?></span>
				</div>
				<div class="aisales-stat-card">
					<span class="aisales-stat-card__value"><?php echo esc_html( $stats['recovery_rate'] ); ?>%</span>
					<span class="aisales-stat-card__label"><?php esc_html_e( 'Recovery Rate', 'stacksuite-sales-manager-for-woocommerce' ); ?></span>
				</div>
				<div class="aisales-stat-card">
					<span class="aisales-stat-card__value"><?php echo wp_kses_post( $stats['recovered_revenue'] ); ?></span>
					<span class="aisales-stat-card__label"><?php esc_html_e( 'Recovered Revenue', 'stacksuite-sales-manager-for-woocommerce' ); ?></span>
				</div>
			</div>
			...
			<div class="aisales-abandoned-carts-page__table">
				<table class="wp-list-table widefat fixed striped aisales-table-modern">
					<thead>
						<tr>
							<th><?php esc_html_e( 'Email', 'stacksuite-sales-manager-for-woocommerce' ); ?></th>
							<th><?php esc_html_e( 'Status', 'stacksuite-sales-manager-for-woocommerce' ); ?></th>
							<th><?php esc_html_e( 'Cart Contents', 'stacksuite-sales-manager-for-woocommerce' ); ?></th>
							<th><?php esc_html_e( 'Total', 'stacksuite-sales-manager-for-woocommerce' ); ?></th>
							<th><?php esc_html_e( 'Last Activity', 'stacksuite-sales-manager-for-woocommerce' ); ?></th>
					...
					<tbody>
						<?php if ( empty( $rows ) ) : ?>
							<tr>
								<td colspan="6"><?php esc_html_e( 'No carts found yet.', 'stacksuite-sales-manager-for-woocommerce' ); ?></td>
							</tr>
						<?php else : ?>
								...
								<tr class="aisales-abandoned-cart-row" data-cart-id="<?php echo esc_attr( $row['id'] ); ?>">
									<td data-column="email">
										<div class="aisales-cart-email">
											...
											<?php if ( $row['user_id'] ) : ?>
												<span class="aisales-cart-meta"><?php esc_html_e( 'Customer', 'stacksuite-sales-manager-for-woocommerce' ); ?></span>
											<?php endif; ?>
										</div>
									</td>
	...
	private function render_settings_modal() {
		...
		<div class="aisales-modal aisales-abandoned-cart-settings-modal" id="aisales-abandoned-cart-settings-modal">
			<div class="aisales-modal__header">
				<h3 class="aisales-modal__title"><?php esc_html_e( 'Abandoned Cart Settings', 'stacksuite-sales-manager-for-woocommerce' ); ?></h3>
				...
				<div class="aisales-modal__body">
					...
					<div class="aisales-form-group">
						<label class="aisales-form-label" for="aisales-abandon-minutes">
							...
							<?php esc_html_e( 'Abandon After (minutes)', 'stacksuite-sales-manager-for-woocommerce' ); ?>
						</label>
						...
						<span class="aisales-form-hint"><?php esc_html_e( 'Mark carts as abandoned after this many minutes of inactivity.', 'stacksuite-sales-manager-for-woocommerce' ); ?></span>
					</div>

					<div class="aisales-form-group">
						<label class="aisales-form-label" for="aisales-retention-days">
							<span class="dashicons dashicons-calendar-alt"></span>
							<?php esc_html_e( 'Retention (days)', 'stacksuite-sales-manager-for-woocommerce' ); ?>
						</label>
						...
						<span class="aisales-form-hint"><?php esc_html_e( 'Expire carts after this many days.', 'stacksuite-sales-manager-for-woocommerce' ); ?></span>
					</div>

					<div class="aisales-form-group">
						<label class="aisales-form-label">
							<span class="dashicons dashicons-email"></span>
							<?php esc_html_e( 'Recovery Emails', 'stacksuite-sales-manager-for-woocommerce' ); ?>
						</label>
					...
					<div class="aisales-form-group">
						<label class="aisales-form-label">
							...
							<?php esc_html_e( 'Email Timing (hours after abandonment)', 'stacksuite-sales-manager-for-woocommerce' ); ?>
						</label>
						<div class="aisales-email-timing-grid">
							...
							<div class="aisales-email-timing-item">
								<label for="aisales-email-step-2"><?php esc_html_e( 'Email 2', 'stacksuite-sales-manager-for-woocommerce' ); ?></label>
							...
							<div class="aisales-email-timing-item">
								<label for="aisales-email-step-3"><?php esc_html_e( 'Email 3', 'stacksuite-sales-manager-for-woocommerce' ); ?></label>
					...
					<div class="aisales-form-group">
						<label class="aisales-form-label" for="aisales-restore-redirect">
							...
							<?php esc_html_e( 'Restore Link Destination', 'stacksuite-sales-manager-for-woocommerce' ); ?>
						</label>
						...
						<span class="aisales-form-hint"><?php esc_html_e( 'Where customers land after clicking the restore link in emails.', 'stacksuite-sales-manager-for-woocommerce' ); ?></span>
					</div>
				</div>
	...
	private function format_cart_items_summary( $row ) {
		...
		if ( empty( $items ) ) {
			return '<span class="aisales-text-muted">' . esc_html__( 'No items captured yet.', 'stacksuite-sales-manager-for-woocommerce' ) . '</span>';
		}

		$summary  = '<div class="aisales-cart-summary">';
		$summary .= '<div class="aisales-cart-summary__meta">';
		/* translators: %d: number of items */
		$summary .= '<span class="aisales-cart-summary__count">' . esc_html( sprintf( _n( '%d item', '%d items', count( $items ), 'stacksuite-sales-manager-for-woocommerce' ), count( $items ) ) ) . '</span>';
		$summary .= '</div>';
		...
		$summary .= '<span class="aisales-btn__label">' . esc_html__( 'View items', 'stacksuite-sales-manager-for-woocommerce' ) . '</span>';
		$summary .= '</button>';
		$summary .= '</div>';
	...
	private function format_cart_items_details( $row ) {
		...
		$html .= '<span class="aisales-cart-details__title">' . esc_html__( 'Cart items', 'stacksuite-sales-manager-for-woocommerce' ) . '</span>';
		...
		$html .= '<span class="aisales-btn__label">' . esc_html__( 'Hide', 'stacksuite-sales-manager-for-woocommerce' ) . '</span>';
		$html .= '</button>';
		$html .= '</div>';
	...
	private function format_status_badge( $status, $order_id ) {
		...
		switch ( $status ) {
			case 'order_created':
				$label = __( 'Order Created', 'stacksuite-sales-manager-for-woocommerce' );
				$style = 'info';
				break;
			case 'abandoned':
				$label = __( 'Abandoned', 'stacksuite-sales-manager-for-woocommerce' );
				$style = 'warning';
				break;
			case 'recovered':
				$label = __( 'Recovered', 'stacksuite-sales-manager-for-woocommerce' );
				$style = 'success';
				break;
			case 'expired':
				$label = __( 'Expired', 'stacksuite-sales-manager-for-woocommerce' );
				$style = 'muted';
				break;
			default:
				$label = ucfirst( $status );
	...
	private function format_actions( $row ) {
		...
		if ( ! $has_order ) {
			return '<button type="button" class="aisales-btn aisales-btn--primary aisales-btn--sm aisales-abandoned-cart-create-order" data-cart-id="' . esc_attr( $row['id'] ) . '">' .
				'<span class="aisales-btn__label">' . esc_html__( 'Create order', 'stacksuite-sales-manager-for-woocommerce' ) . '</span>' .
			'</button>';
		}

		return '<div class="aisales-action-group" data-order-id="' . esc_attr( $order_id ) . '">' .
			'<button type="button" class="aisales-action-group__btn aisales-abandoned-cart-copy-link" data-payment-url="' . esc_url( $payment_url ) . '" data-tooltip="' . esc_attr__( 'Copy link', 'stacksuite-sales-manager-for-woocommerce' ) . '">' .
				'<span class="dashicons dashicons-admin-links"></span>' .
			'</button>' .
			'<a class="aisales-action-group__btn" href="' . esc_url( $payment_url ) . '" target="_blank" rel="noopener noreferrer" data-tooltip="' . esc_attr__( 'Open payment', 'stacksuite-sales-manager-for-woocommerce' ) . '">' .
				'<span class="dashicons dashicons-external"></span>' .
			'</a>' .
			'<a class="aisales-action-group__btn" href="' . esc_url( $edit_url ) . '" data-tooltip="' . esc_attr__( 'View order', 'stacksuite-sales-manager-for-woocommerce' ) . '">' .

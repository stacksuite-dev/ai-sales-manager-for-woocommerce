 ...
 */
class AISales_Category_Metabox {

	/**
	 * Single instance
	 *
	 * @var AISales_Category_Metabox
	 */
	 ...
	 * Get instance
	 *
	 * @return AISales_Category_Metabox
	 */
	...
	public function enqueue_scripts( $hook ) {
		...
		wp_add_inline_style( 'aisales-admin', $this->get_inline_styles() );
	}
	...
	private function get_inline_styles() {
		return '
			...
			.aisales-category-metabox__header {
				display: flex;
				align-items: center;
				gap: 8px;
				margin-bottom: 12px;
			}
			.aisales-category-metabox__header h4 {
				margin: 0;
				font-size: 14px;
				font-weight: 600;
				color: #1e1e1e;
			}
			.aisales-category-metabox__header .dashicons {
				color: var(--aisales-primary, #5c5ce5);
				font-size: 18px;
				width: 18px;
				height: 18px;
			}
			.aisales-category-metabox__content p {
				margin: 0 0 12px;
				color: #50575e;
				font-size: 13px;
				line-height: 1.5;
			}
			.aisales-category-metabox .button-primary {
				display: inline-flex;
				align-items: center;
				gap: 6px;
				background: var(--aisales-primary, #5c5ce5);
				border-color: var(--aisales-primary, #5c5ce5);
			}
			.aisales-category-metabox .button-primary:hover,
			.aisales-category-metabox .button-primary:focus {
				background: var(--aisales-primary-dark, #4b4bd4);
				border-color: var(--aisales-primary-dark, #4b4bd4);
			}
			.aisales-category-metabox .button-primary .dashicons {
				font-size: 16px;
				width: 16px;
				height: 16px;
				line-height: 1;
			}
			.aisales-category-metabox--not-connected {
				text-align: center;
			}
			.aisales-category-metabox--not-connected .dashicons-admin-network {
				font-size: 24px;
				width: 24px;
				height: 24px;
				color: #b3b3b3;
			...
			.aisales-category-metabox--add {
				padding: 12px;
			}
			.aisales-category-metabox--add p {
				color: #646970;
				font-style: italic;
				margin: 0;
			}
			.aisales-category-metabox--add .dashicons {
				font-size: 14px;
				width: 14px;
				height: 14px;
	...
	public function render_edit_fields( $term ) {
		$is_connected = AISales_API_Client::instance()->is_connected();
		?>
		<tr class="form-field">

	...
	<?php if ( empty( $aisales_api_key ) ) : ?>
		...
		<div class="aisales-email-page__not-connected">
			<div class="aisales-empty-state">
				...
				<p><?php esc_html_e( 'Please connect your StackSuite Sales Manager account to use email templates.', 'stacksuite-sales-manager-for-woocommerce' ); ?></p>
	...
	<?php else : ?>
		...
		<nav class="aisales-email-page__tabs">
			<button type="button" class="aisales-email-tab aisales-email-tab--active" data-tab="templates">
				<span class="dashicons dashicons-email-alt"></span>
				<span class="aisales-email-tab__text"><?php esc_html_e( 'Templates', 'stacksuite-sales-manager-for-woocommerce' ); ?></span>
			...
			<button type="button" class="aisales-email-tab" data-tab="settings">
				...
				<span class="aisales-email-tab__text"><?php esc_html_e( 'Settings', 'stacksuite-sales-manager-for-woocommerce' ); ?></span>
			</button>
		</nav>
			...
			<div class="aisales-email-overview">
				<div class="aisales-email-stats">
					<div class="aisales-email-stat aisales-email-stat--active">
						...
						<span class="aisales-email-stat__label"><?php esc_html_e( 'Active', 'stacksuite-sales-manager-for-woocommerce' ); ?></span>
					</div>
					<div class="aisales-email-stat aisales-email-stat--draft">
						...
						<span class="aisales-email-stat__label"><?php esc_html_e( 'Draft', 'stacksuite-sales-manager-for-woocommerce' ); ?></span>
					</div>
					<div class="aisales-email-stat aisales-email-stat--none">
						...
						<span class="aisales-email-stat__label"><?php esc_html_e( 'Not Created', 'stacksuite-sales-manager-for-woocommerce' ); ?></span>
					</div>
				</div>

				<div class="aisales-email-actions">
					<button type="button" class="aisales-btn aisales-btn--pill" id="aisales-brand-settings-btn" title="<?php esc_attr_e( 'Configure your brand voice and tone for AI-generated emails', 'stacksuite-sales-manager-for-woocommerce' ); ?>">
					...
					<button type="button" class="aisales-btn aisales-btn--pill" id="aisales-generate-all-btn" <?php echo $aisales_stats['not_created'] === 0 ? 'disabled' : ''; ?>>
						...
						<?php esc_html_e( 'Generate All Missing', 'stacksuite-sales-manager-for-woocommerce' ); ?>
					</button>
				</div>
			</div>
										...
										<div class="aisales-email-template-card__status">
											...
											<?php elseif ( $aisales_template_data['has_template'] ) : ?>
												<span class="aisales-status-badge aisales-status-badge--draft">
													...
													<?php esc_html_e( 'Draft', 'stacksuite-sales-manager-for-woocommerce' ); ?>
												</span>
											<?php else : ?>
												<span class="aisales-status-badge aisales-status-badge--none">
													<span class="dashicons dashicons-minus"></span>
													<?php esc_html_e( 'Not Created', 'stacksuite-sales-manager-for-woocommerce' ); ?>
												</span>
											<?php endif; ?>
										</div>
										<div class="aisales-email-template-card__actions">
											<?php if ( $aisales_template_data['has_template'] ) : ?>
												<button type="button" class="aisales-btn aisales-btn--outline aisales-btn--sm aisales-email-edit-btn" 
													...
													title="<?php esc_attr_e( 'Edit Template', 'stacksuite-sales-manager-for-woocommerce' ); ?>">
													<span class="dashicons dashicons-edit"></span>
													<span class="aisales-btn__text"><?php esc_html_e( 'Edit', 'stacksuite-sales-manager-for-woocommerce' ); ?></span>
												</button>
												<label class="aisales-toggle-switch" title="<?php echo $aisales_template_data['is_active'] ? esc_attr__( 'Deactivate', 'stacksuite-sales-manager-for-woocommerce' ) : esc_attr__( 'Activate', 'stacksuite-sales-manager-for-woocommerce' ); ?>">
											...
											<?php else : ?>
												<button type="button" class="aisales-btn aisales-btn--primary aisales-btn--sm aisales-email-generate-btn" 
													data-template-type="<?php echo esc_attr( $aisales_type ); ?>">
													<span class="dashicons dashicons-admin-customizer"></span>
													<span class="aisales-btn__text"><?php esc_html_e( 'Generate', 'stacksuite-sales-manager-for-woocommerce' ); ?></span>
												</button>
											<?php endif; ?>
										</div>
									</div>
				...
				<div class="aisales-email-help">
					...
					<div class="aisales-email-help__content">
						<h4><?php esc_html_e( 'How it works', 'stacksuite-sales-manager-for-woocommerce' ); ?></h4>
						<p><?php esc_html_e( 'AI-generated email templates replace the default WooCommerce transactional emails. Generate templates using your store context, customize them with placeholders, and activate to start sending personalized emails.', 'stacksuite-sales-manager-for-woocommerce' ); ?></p>
					</div>
				</div>
			</div>
			...
			<div class="aisales-email-page__editor-view" id="aisales-email-editor-view" style="display: none;">
				...
				<div class="aisales-email-editor__header">
					<button type="button" class="aisales-btn aisales-btn--ghost" id="aisales-email-back-btn">
						...
						<?php esc_html_e( 'Back to Templates', 'stacksuite-sales-manager-for-woocommerce' ); ?>
					</button>
					...
					<div class="aisales-email-editor__header-actions">
						<button type="button" class="aisales-btn aisales-btn--ghost aisales-btn--sm" id="aisales-email-test-btn">
							<span class="dashicons dashicons-email"></span>
							<?php esc_html_e( 'Send Test', 'stacksuite-sales-manager-for-woocommerce' ); ?>
						</button>
						<button type="button" class="aisales-btn aisales-btn--ghost aisales-btn--sm aisales-btn--danger" id="aisales-email-delete-btn">
							...
							<?php esc_html_e( 'Delete', 'stacksuite-sales-manager-for-woocommerce' ); ?>
						</button>
					</div>
				</div>
					...
					<div class="aisales-email-editor__form-pane">
						<form id="aisales-email-editor-form" class="aisales-email-editor__form">
							...
							<div class="aisales-email-field">
								<label for="aisales-email-name">
									...
									<?php esc_html_e( 'Template Name', 'stacksuite-sales-manager-for-woocommerce' ); ?>
								</label>
								<input type="text" id="aisales-email-name" name="name" 
									placeholder="<?php esc_attr_e( 'e.g., Order Confirmation - Friendly', 'stacksuite-sales-manager-for-woocommerce' ); ?>">
							</div>
							...
							<div class="aisales-email-field">
								<label for="aisales-email-subject">
									<span class="dashicons dashicons-email"></span>
									<?php esc_html_e( 'Subject Line', 'stacksuite-sales-manager-for-woocommerce' ); ?>
									<button type="button" class="aisales-regenerate-btn" data-field="subject" title="<?php esc_attr_e( 'Regenerate with AI', 'stacksuite-sales-manager-for-woocommerce' ); ?>">
										<span class="dashicons dashicons-update"></span>
									</button>
								</label>
								<div class="aisales-email-field__input-wrap">
									<input type="text" id="aisales-email-subject" name="subject" 
										placeholder="<?php esc_attr_e( 'e.g., Order #{order_number} confirmed!', 'stacksuite-sales-manager-for-woocommerce' ); ?>">
									<button type="button" class="aisales-placeholder-insert-btn" data-target="aisales-email-subject" title="<?php esc_attr_e( 'Insert Placeholder', 'stacksuite-sales-manager-for-woocommerce' ); ?>">
							...
							<div class="aisales-email-field">
								<label for="aisales-email-heading">
									...
									<?php esc_html_e( 'Email Heading', 'stacksuite-sales-manager-for-woocommerce' ); ?>
									<button type="button" class="aisales-regenerate-btn" data-field="heading" title="<?php esc_attr_e( 'Regenerate with AI', 'stacksuite-sales-manager-for-woocommerce' ); ?>">
										<span class="dashicons dashicons-update"></span>
									</button>
								</label>
								<div class="aisales-email-field__input-wrap">
									<input type="text" id="aisales-email-heading" name="heading" 
										placeholder="<?php esc_attr_e( 'e.g., Thank you for your order!', 'stacksuite-sales-manager-for-woocommerce' ); ?>">
									<button type="button" class="aisales-placeholder-insert-btn" data-target="aisales-email-heading" title="<?php esc_attr_e( 'Insert Placeholder', 'stacksuite-sales-manager-for-woocommerce' ); ?>">
										<span class="dashicons dashicons-plus-alt2"></span>
									</button>
								</div>
							</div>
							...
							<div class="aisales-email-field aisales-email-field--content">
								<label for="aisales-email-content">
									...
									<?php esc_html_e( 'Email Content', 'stacksuite-sales-manager-for-woocommerce' ); ?>
									<button type="button" class="aisales-regenerate-btn" data-field="content" title="<?php esc_attr_e( 'Regenerate with AI', 'stacksuite-sales-manager-for-woocommerce' ); ?>">
										<span class="dashicons dashicons-update"></span>
									</button>
								</label>
								<div class="aisales-email-field__textarea-wrap">
									<textarea id="aisales-email-content" name="content" rows="10"
										placeholder="<?php esc_attr_e( 'Write your email content here. Use placeholders like {customer_name} to personalize...', 'stacksuite-sales-manager-for-woocommerce' ); ?>"></textarea>
									<button type="button" class="aisales-placeholder-insert-btn aisales-placeholder-insert-btn--textarea" data-target="aisales-email-content">
										<span class="dashicons dashicons-plus-alt2"></span>
										<?php esc_html_e( 'Insert Placeholder', 'stacksuite-sales-manager-for-woocommerce' ); ?>
									</button>
								</div>
							</div>
							...
							<div class="aisales-email-field aisales-email-field--ai">
								<label>
									<span class="dashicons dashicons-admin-customizer"></span>
									<?php esc_html_e( 'Improve with AI', 'stacksuite-sales-manager-for-woocommerce' ); ?>
								</label>
								<div class="aisales-email-improve-wrap">
									<input type="text" id="aisales-email-improve-prompt" 
										placeholder="<?php esc_attr_e( 'e.g., Make it more friendly, add urgency, shorter...', 'stacksuite-sales-manager-for-woocommerce' ); ?>">
							...
							<div class="aisales-email-placeholders-ref">
								<button type="button" class="aisales-email-placeholders-toggle" id="aisales-placeholders-toggle">
									...
									<?php esc_html_e( 'Available Placeholders', 'stacksuite-sales-manager-for-woocommerce' ); ?>
						...
						<div class="aisales-email-editor__form-actions">
							<button type="button" class="aisales-btn aisales-btn--outline" id="aisales-email-save-draft">
								<?php esc_html_e( 'Save Draft', 'stacksuite-sales-manager-for-woocommerce' ); ?>
							</button>
							<button type="button" class="aisales-btn aisales-btn--primary" id="aisales-email-save-activate">
								<span class="dashicons dashicons-saved"></span>
								<?php esc_html_e( 'Save & Activate', 'stacksuite-sales-manager-for-woocommerce' ); ?>
							</button>
						</div>
					</div>
						...
						<div class="aisales-email-preview">
							...
							<div class="aisales-email-preview__header">
								...
								<div class="aisales-email-preview__device-switcher">
									<button type="button" class="aisales-device-btn aisales-device-btn--active" data-device="mobile" title="<?php esc_attr_e( 'Mobile (375px)', 'stacksuite-sales-manager-for-woocommerce' ); ?>">
										<span class="dashicons dashicons-smartphone"></span>
									</button>
									<button type="button" class="aisales-device-btn" data-device="tablet" title="<?php esc_attr_e( 'Tablet (768px)', 'stacksuite-sales-manager-for-woocommerce' ); ?>">
										<span class="dashicons dashicons-tablet"></span>
									</button>
									<button type="button" class="aisales-device-btn" data-device="desktop" title="<?php esc_attr_e( 'Desktop (100%)', 'stacksuite-sales-manager-for-woocommerce' ); ?>">
							...
							<div class="aisales-email-preview__subject">
								<strong><?php esc_html_e( 'Subject:', 'stacksuite-sales-manager-for-woocommerce' ); ?></strong>
								<span id="aisales-preview-subject"><?php esc_html_e( 'Your subject line will appear here...', 'stacksuite-sales-manager-for-woocommerce' ); ?></span>
							</div>
							...
							<div class="aisales-email-preview__frame-container" id="aisales-preview-container">
								<div class="aisales-email-preview__frame-wrapper" id="aisales-preview-wrapper">
									<iframe id="aisales-preview-iframe" title="<?php esc_attr_e( 'Email Preview', 'stacksuite-sales-manager-for-woocommerce' ); ?>"></iframe>
								</div>
							</div>
							...
							<div class="aisales-email-preview__footer">
								<span class="dashicons dashicons-info-outline"></span>
								<?php esc_html_e( 'Preview uses sample order data', 'stacksuite-sales-manager-for-woocommerce' ); ?>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="aisales-email-loading" id="aisales-email-loading" style="display: none;">
			<div class="aisales-email-loading__content">
				...
				<p id="aisales-loading-message"><?php esc_html_e( 'Generating email template...', 'stacksuite-sales-manager-for-woocommerce' ); ?></p>
			</div>
		</div>

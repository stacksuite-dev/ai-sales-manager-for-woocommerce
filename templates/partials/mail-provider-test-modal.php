...
<div class="aisales-modal aisales-mail-provider-test" id="aisales-mail-provider-test" role="dialog" aria-modal="true" aria-labelledby="aisales-mail-provider-test-title">
	<div class="aisales-modal__header">
		...
		<button type="button" class="aisales-modal__close" id="aisales-mail-provider-test-close" aria-label="<?php esc_attr_e( 'Close', 'stacksuite-sales-manager-for-woocommerce' ); ?>">
	...
	<div class="aisales-modal__body">
		<div class="aisales-form-group">
			<label class="aisales-form-label" for="aisales-mail-provider-test-recipient">
				...
				<?php esc_html_e( 'Recipient Email', 'stacksuite-sales-manager-for-woocommerce' ); ?>
			</label>
			<input
				type="email"
				class="aisales-form-input"
				id="aisales-mail-provider-test-recipient"
				placeholder="<?php esc_attr_e( 'name@example.com', 'stacksuite-sales-manager-for-woocommerce' ); ?>"
			>
			<span class="aisales-form-hint">
				<?php esc_html_e( 'Send a sample delivery email to verify settings.', 'stacksuite-sales-manager-for-woocommerce' ); ?>
			</span>
		</div>
	</div>
	...
	<div class="aisales-modal__footer">
		<div class="aisales-modal__info">
			...
			<?php esc_html_e( 'Use a mailbox you can access to confirm delivery.', 'stacksuite-sales-manager-for-woocommerce' ); ?>
		</div>
